...
<body>
  ...
  <form action="../controladores/r_instructor.php" method="POST" id="form">
    ...
    <fieldset>
      ...
      <input type="number" name="CC" id="imp" placeholder="Numero de Identificacion" required  maxlength="12" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
